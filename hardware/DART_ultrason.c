...
unsigned short new_data = 0x00 absolute 0xCA;
sbit new_data_sonar_1 at new_data.B0;
sbit new_data_sonar_2 at new_data.B1;
sbit new_data_sonar_3 at new_data.B2;
sbit new_data_sonar_4 at new_data.B3;

#define TIME_MAX_CST 125000 // min = 400cm * 58/0.2 = 116000 (every 23.2 ms), set to 25ms
...
void set_new_data(unsigned char id){
		switch(id){
				case 0:
						new_data_sonar_1 = 1;
						break;
